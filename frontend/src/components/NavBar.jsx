...
export default function Navbar() {
  return (
    <nav className="fixed w-full h-25 bg-gradient-to-r from-gray-600 via-pink-500 to-orange-700 text-black shadow z-50">
    <div className="container mx-auto flex justify-between items-center p-4">
    <h1 className="text-l mr-90 font-bold">Reeban Austrive</h1>
