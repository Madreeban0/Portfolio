        ...
        <div className="flex flex-col text-center md:text-left max-w-xl">
          ...
          <div className="flex gap-4 justify-center md:justify-start">
            <a href="https://www.linkedin.com/in/reeban-austrive-11019a254/" target="_blank" rel="noopener noreferrer">
              <img src="/linkedin.png" alt="LinkedIn" className="w-12 h-12 object-cover cursor-pointer hover:opacity-80 transition" />
            </a>
            <a href="https://github.com/Madreeban0" target="_blank" rel="noopener noreferrer">
              <img src="/github.png" alt="GitHub" className="w-12 h-12 object-cover cursor-pointer hover:opacity-80 transition" />
            </a>
            <a href="https://www.instagram.com/moxey_00/" target="_blank" rel="noopener noreferrer">
              <img src="/instagram.png" alt="Instagram" className="w-12 h-12 object-cover cursor-pointer hover:opacity-80 transition" />
            </a>
          </div>
        </div>
      </div>
